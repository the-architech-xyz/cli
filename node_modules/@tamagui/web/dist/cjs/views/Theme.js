...
var import_constants = require("@tamagui/constants"), import_react = __toESM(require("react"), 1), import_config = require("../config"), import_createVariable = require("../createVariable"), import_useTheme = require("../hooks/useTheme"), import_useThemeState = require("../hooks/useThemeState"), import_ThemeDebug = require("./ThemeDebug"), import_jsx_runtime = require("react/jsx-runtime");
const Theme = (0, import_react.forwardRef)(function(props, ref) {
  if (props.disable)
    return props.children;
  const { passThrough } = props, isRoot = !!props._isRoot, [_, themeState] = (0, import_useTheme.useThemeWithState)(props, isRoot);
  let finalChildren = props["disable-child-theme"] ? import_react.Children.map(
    props.children,
    (child) => passThrough ? child : (0, import_react.cloneElement)(child, { "data-disable-theme": !0 })
  ) : props.children;
  if (ref)
    try {
...
function getThemedChildren(themeState, children, props, isRoot = !1, stateRef, passThrough = !1) {
  ...
  if (process.env.NODE_ENV === "development" && props.debug === "visualize" && (children = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ThemeDebug.ThemeDebug, { themeState, themeProps: props, children })), !shouldRenderChildrenWithTheme)
    return children;
  ...
  themeState.name === "dark" || themeState.name === "light") && (state.hasEverThemed = "wrapped"), shallow && themeState.parentId) {
    ...
    children = import_react.Children.toArray(children).map((child) => (0, import_react.isValidElement)(child) ? passThrough ? child : (0, import_react.cloneElement)(
      child,
      void 0,
  ...
  if (import_constants.isWeb) {
    ...
    if (children = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ...
      children = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: baseStyle, className: className2, children });
    }
    return children;
  }
  return children;
