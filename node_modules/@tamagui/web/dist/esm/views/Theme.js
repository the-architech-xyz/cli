...
const Theme = forwardRef(function(props, ref) {
  ...
  let finalChildren = props["disable-child-theme"] ? Children.map(
    props.children,
    (child) => passThrough ? child : cloneElement(child, { "data-disable-theme": !0 })
  ) : props.children;
  if (ref)
    try {
...
function getThemedChildren(themeState, children, props, isRoot = !1, stateRef, passThrough = !1) {
  ...
  if (process.env.NODE_ENV === "development" && props.debug === "visualize" && (children = /* @__PURE__ */ jsx(ThemeDebug, { themeState, themeProps: props, children })), !shouldRenderChildrenWithTheme)
    return children;
  ...
  themeState.name === "dark" || themeState.name === "light") && (state.hasEverThemed = "wrapped"), shallow && themeState.parentId) {
    ...
    children = Children.toArray(children).map((child) => isValidElement(child) ? passThrough ? child : cloneElement(
      child,
      void 0,
  ...
  if (isWeb) {
    ...
    if (children = /* @__PURE__ */ jsx(
      ...
      children = /* @__PURE__ */ jsx("span", { style: baseStyle, className: className2, children });
    }
    return children;
  }
  return children;
