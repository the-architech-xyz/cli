...
export default function WelcomePage() {
  ...
  return (
    <WelcomeLayout>
      ...
      {/* Technology Stack */}
      <% if (module.parameters.features?.techStack) { %>
      <motion.section
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      {/* Component Showcase */}
      <% if (module.parameters.features?.componentShowcase) { %>
      <motion.section
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      {/* Project Structure */}
      <% if (module.parameters.features?.projectStructure) { %>
      <motion.section
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="text-center space-y-4">
          <% if (module.parameters.features?.architechBranding) { %>
