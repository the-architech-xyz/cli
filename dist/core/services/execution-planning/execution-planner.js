...
export class ExecutionPlanner {
    ...
    estimateBatchDuration(modules) {
        ...
        if (modules.length > 1) {
            const maxCategoryDuration = Math.max(...modules.map(m => categoryDurations[m.category || 'unknown'] || 5000));
     ...
     */
    getBatchDependencies(modules, graph) {
