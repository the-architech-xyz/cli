...
export class JsExportWrapperModifier extends BaseModifier {
     ...
     */
    addImport(sourceFile, importSpec) {
    ...
    wrapExport(sourceFile, params) {
        ...
        if (exportDefault) {
            const exportAssignment = sourceFile.getStatements()
                .find((stmt) => stmt.getKind() === SyntaxKind.ExportAssignment);
            if (exportAssignment) {
...
//# sourceMappingURL=js-export-wrapper.js.map