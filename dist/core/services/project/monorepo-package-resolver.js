...
export class MonorepoPackageResolver {
     ...
     */
    static resolveTargetPackage(module, genome) {
        ...
        if (genomeModule && genomeModule.targetPackage) {
            const targetPackage = genomeModule.targetPackage;
        ...
        if (module.targetPackage) {
            const targetPackage = module.targetPackage;
        ...
        if (usage.frontend && usage.backend) {
            ...
            const frontendApps = apps.filter((a) => a.type === 'web' || a.type === 'mobile');
    ...
    static findGenomeModule(moduleId, genome) {
        ...
        for (const module of genome.modules) {
            const moduleIdToCheck = typeof module === 'string' ? module : module.id;
     ...
     */
    static inferModuleLayer(moduleId) {
     ...
     */
    static inferModuleUsage(module, layer) {
        const moduleId = module.id.toLowerCase();
...
//# sourceMappingURL=monorepo-package-resolver.js.map