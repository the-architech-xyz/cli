...
import { FilePathStrategy, LocalMarketplaceStrategy, NpmPackageStrategy, CustomSourceStrategy } from './strategies/index.js';
export class GenomeResolverFactory {
     ...
     */
    static async createFromConfigFile(configPath) {
    ...
    static async loadConfig(configPath) {
        ...
        try {
            ...
            const config = await ArchitechConfigLoader.load(configPath || process.cwd());
            return config;
        }
        catch (error) {
...
//# sourceMappingURL=genome-resolver-factory.js.map