...
export class MarketplaceRegistry {
     ...
     */
    static async getUIMarketplacePath(framework) {
        // Check for override first
     ...
     */
    static async resolvePath(devPath, prodPath) {
        try {
     ...
     */
    static setMarketplacePath(name, path) {
     ...
     */
    static async marketplaceExists(name) {
        try {
     ...
     */
    static async getAvailableUIMarketplaces() {
        const available = [];
