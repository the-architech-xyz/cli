...
export class EnhancedLogger {
     ...
     */
    completePhase() {
        if (this.quiet || !this.currentPhase)
            return;
     ...
     * Log module progress
     */
    logModuleProgress(moduleId, status) {
        if (this.quiet)
            return;
     ...
     */
    logNextSteps(projectPath, projectName) {
        if (this.quiet)
            return;
        console.log();
